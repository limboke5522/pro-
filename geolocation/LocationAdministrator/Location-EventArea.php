					...
					<section>
                        <table id="example" class="display" cellspacing="0" width="100%">
							...
							<tr>
                                    ...
                                    <td valign="middle"><? echo $event_title; ?></td>
                                    <td valign="middle"><? echo $event_des; ?></td>                    
                                    <td valign="middle"><? echo $event_Latitude; ?> , <? echo $event_Longitude; ?></td>
                                    <td valign="middle"><center><img src="../icon/<? echo $event_icon; ?>" alt=""/></center></td>  
                                    <td valign="middle"><center><img src="../icon/<? echo $event_pic; ?>" alt="" width="50px"/></center></td>
