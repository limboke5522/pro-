...
<div class="panel">
    ...
    <form method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="panel-mainhalfL">   
            ...
            <input type="text" name="eventtitle" value="<? echo $event_title; ?>">
            </div>
            </div> 
        </div>
          ...
          <div class="panel-mainhalfR">       
   		...
   		<div class="input-control text full-size">
  		<input type="text" name="eventlink" value="<? echo $event_link; ?>">
   		</div>
    	</div>  
   	</div>
     ...
     <div class="panel-main">            
        ...
        <input type="text" name="eventdes" value="<? echo $event_des; ?>">
        </div>
        </div>
    </div>
    ...
    <div class="panel-mainhalfL">
   		...
   		<div class="input-control text full-size">
  		<input type="text" class="float" name="eventLatitude" value="<? echo $event_Latitude; ?>">
   		</div>
    	</div>  
   	</div>
    ...
    <div class="panel-mainhalfR">
   		...
   		<div class="input-control text full-size">
  		<input type="text" class="float" name="eventLongitude" value="<? echo $event_Longitude; ?>">
   		</div>
    	</div>  
    </div>
